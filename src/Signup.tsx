                                ...
                                <div id="accordion">
                                    <div className="card ">
                                        <div className="card-header " id="headingOne">
                                            <h3 className="mb-0">
                                                <button className="btn btn-link mr-5" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                    Account info
                                                </button>
                                                <button className="btn btn-link mr-5" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                                                    Delivery info
                                                </button>
                                                ...
                                                <div className="row justify-content-center">
                                                    <div className="control-group col-10 col-sm-10 col-md-7 text-center">
                                                        ...
                                                        <div className="form form-group float-right">
                                                            <button type="button" className="btn btn-primary btn-xl" id="Step1NextButton" value="Send">Next</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
